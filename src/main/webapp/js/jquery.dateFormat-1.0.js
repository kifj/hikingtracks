(function ($) {
    ...
    $.format = (function () {
        function strDay(value) {
 						return $.i18n.prop(daysInWeek[parseInt(value, 10)]) || value;
        }

        function strMonth(value) {
						var monthArrayIndex = parseInt(value, 10) - 1;
 						return $.i18n.prop(shortMonthsInYear[monthArrayIndex]) || value;
        }

        function strLongMonth(value) {
					var monthArrayIndex = parseInt(value, 10) - 1;
					return $.i18n.prop(longMonthsInYear[monthArrayIndex]) || value;					
        }
